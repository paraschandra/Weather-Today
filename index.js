...
function getWeather(){
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityInput}&appid=${API_KEY}&units=metric`)
        ...
        .then(data => {
            ...
            if(code == 800){
                app.style.backgroundImage = `url(./assets/images/${timeOfDay}/clear.webp)`;
                ...
                app.style.backgroundImage = `url(./assets/images/${timeOfDay}/cloudy.webp)`;
                ...
                app.style.backgroundImage = `url(./assets/images/${timeOfDay}/rain.webp)`;
                ...
                app.style.backgroundImage = `url(./assets/images/${timeOfDay}/atmosphere.webp)`;
                ...
                app.style.backgroundImage = `url(./assets/images/${timeOfDay}/snow.webp)`;
